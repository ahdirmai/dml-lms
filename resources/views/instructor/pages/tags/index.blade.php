<x-app-layout :title="'Tags'">
    <x-slot name="header">
        <h2 class="font-bold text-xl text-dark leading-tight">Tags</h2>
    </x-slot>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end gap-2">
                                        <button type="button" 
                                            ...
                                            title="Edit Tag"
                                            data-action="{{ route('instructor.tags.update', $t) }}"
                                            data-name="{{ $t->name }}"
                                            data-slug="{{ $t->slug }}">
                                            <x-ui.icon name="pencil" class="w-4 h-4" />
                                        </button>
                                        <form action="{{ route('instructor.tags.destroy', $t) }}" method="POST" onsubmit="return confirm('Delete this tag?')">
                                            @csrf @method('DELETE')
            ...
            <div class="md:hidden space-y-4">
                ...
                <div class="bg-white shadow-sm rounded-xl border border-gray-100 p-4">
                    ...
                    <div class="flex gap-2 mt-4 pt-3 border-t border-gray-100">
                        ...
                        <form action="{{ route('instructor.tags.destroy', $t) }}" method="POST" class="flex-1" onsubmit="return confirm('Delete this tag?')">
                            @csrf @method('DELETE')
    ...
    <script>
        (function () {
            ...
            function clearCreateForm() {
                ...
                createForm.action = "{{ route('instructor.tags.store') }}";
