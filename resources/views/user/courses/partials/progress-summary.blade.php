...
<section class="bg-white rounded-2xl shadow-custom-soft border border-gray-100 p-5 sm:p-6">
    ...
    <div class="mt-4 flex flex-col sm:flex-row sm:items-center gap-2">
        ...
        <a href="{{ $ctaHref }}" class="inline-flex items-center justify-center px-4 py-2.5 rounded-xl text-sm font-semibold text-white shadow
                  {{ $pretestGateActive ? 'bg-gray-400 cursor-not-allowed pointer-events-none'
        ...
        <div class="flex flex-wrap items-center gap-2 text-[11px]">
            ...
            @if($hasPostTest && $preDone && !$postDone)
