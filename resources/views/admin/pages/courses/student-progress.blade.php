{{-- resources/views/admin/pages/courses/student-progress.blade.php --}}
<x-app-layout :title="'Student Progress — ' . $student->name">
    ...
    <a href="{{ route('admin.courses.progress', $course->id) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <div class="space-y-2 text-sm">
                            ...
                            <div><span class="font-semibold">Instructor:</span> {{ $course->instructor->name ?? '-' }}</div>
